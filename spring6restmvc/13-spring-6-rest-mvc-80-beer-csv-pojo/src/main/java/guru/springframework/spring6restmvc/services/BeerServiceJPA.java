...
public class BeerServiceJPA implements BeerService {
    ...
    private List<Beer> listBeersByNameAndStyle(String beeerName,BeerStyle beerStyle) {
       return beerRepository.findAllByBeerNameIsLikeIgnoreCaseAndBeerStyle("%"+beeerName+"%",beerStyle);
    }
